...
def main():
    ...
    <div style='text-align: center; color: #888888;'>
        Upload a resume in PDF, DOCX, or TXT format, and get the predicted job category.
    </div>
    ...
    if uploaded_file is not None:
        ...
        with st.spinner("Processing... Please wait."):
            ...
            try:
                ...
                st.markdown(f"<h3 style='text-align: center; color: #FF9800;'>The predicted category of the uploaded resume is: <b>{category}</b></h3>", unsafe_allow_html=True)
